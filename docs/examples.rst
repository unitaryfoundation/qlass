...
.. code-block:: python
   ...
   draw_circuit(processor, output_format="mpl", save_path="ansatz.png", recursive=True)
   ...
   vqe.draw_ansatz(params, output_format="text", save_path="ansatz.txt", recursive=True)
